...
(function(root) {
  root.Parse = root.Parse || {};
  /**
   * Contains all Parse API baseClasses and functions.
   * @name Parse
   * @namespace
   *
   * Contains all Parse API baseClasses and functions.
  ...
  /**
   * Options:
   *   route: is baseClasses, users, login, etc.
          ...
          return Parse._request({
            ...
            data: {
              requests: _.map(batch, function(object) {
                return {
                  method: "DELETE",
                  path: "/1/baseClasses/" + object.className + "/" + object.id
                };
              })
            }
          });
          ...
          return Parse._request({
            ...
            data: {
              requests: _.map(batch, function(object) {
                ...
                var path = "/1/baseClasses/" + object.className;
                if (object.id) {
                  path = path + "/" + object.id;
                  method = "PUT";
                }
